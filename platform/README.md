...
**Status:** design doc + **implemented M1 & Lean v1** on **Coolify** (the engine — the Kiosk drives it via REST; see [`coolify/README.md`](./coolify/README.md)); pipeline/security detail in [`M1.md`](./M1.md) / [`v1.md`](./v1.md), set-up in [`SETUP.md`](./SETUP.md) (run it on a Mac via Colima: [`local/README.md`](./local/README.md)) · **Trust model:** trusted-internal, accident-hardened · **Purpose:** alignment, stakeholder buy-in, discovery.
